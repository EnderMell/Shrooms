...
if ( ! class_exists( 'Amble_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Amble_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'amble-slider', get_template_directory_uri() . '/inc/customizer/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'amble-slider', get_template_directory_uri() . '/inc/customizer/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); // for slider control               
        }
