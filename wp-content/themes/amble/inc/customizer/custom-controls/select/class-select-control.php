...
if ( ! class_exists( 'Amble_Select_Control' ) ) {

	// Select control.
	class Amble_Select_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'amble-select', get_template_directory_uri() . '/inc/customizer/custom-controls/select/select.js', array( 'jquery', 'selectize' ), false, true ); // for multi select    
        }
